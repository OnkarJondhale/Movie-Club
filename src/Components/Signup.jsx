...
function Signup(props)
{
    ...
    return(
    <>
     <img src="signupbackground.jpg" className="h-screen w-screen absolute -z-10"/>
     ...
     <div className="h-screen w-screen flex justify-center items-center">
        <div className="min-h-60 min-w-fit p-4 border-4 border-black rounded-xl font-mono shadow-4xl shadow-black z-10 flex flex-col justify-center gap-4 bg-slate-800">
            <h1 className=" font-bold bg-black text-white text-center content-center p-1 border-2 border-white rounded-xl"> Sign-Up </h1>
            ...
            <div className="flex justify-center items-center">
                <button className="bg-black text-white px-2 py-1 rounded-xl cursor-pointer border-2 border-white hover:bg-blue-800" onClick={signuphandler}> Create Account </button>
            </div>
            <div className="bg-black text-white text-center content-center text-sm rounded-lg flex gap-1"> Already have account? <p className='underline hover:bg-blue-800 cursor-pointer' onClick={props.setSignUp}>Login</p> Here </div>
